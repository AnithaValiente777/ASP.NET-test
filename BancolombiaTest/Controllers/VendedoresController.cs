...
namespace BancolombiaTest
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(EFGContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,CODVENTAS,NOMVEND")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CODVENTAS,NOMVEND")] Vendedor vendedor)
        {
            if (id != vendedor.ID)
            {
                return NotFound();
